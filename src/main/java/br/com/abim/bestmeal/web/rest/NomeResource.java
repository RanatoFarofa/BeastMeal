...
public class NomeResource {
     ...
     */
    @PostMapping("/nomes")
    public ResponseEntity<Nome> createNome(@RequestBody Nome nome) throws URISyntaxException {
     ...
     */
    @PutMapping("/nomes")
    public ResponseEntity<Nome> updateNome(@RequestBody Nome nome) throws URISyntaxException {
