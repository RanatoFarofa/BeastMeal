...
public class MunicipioResourceIntTest {
    ...
    private static final UF DEFAULT_U_F = UF.AC;
    private static final UF UPDATED_U_F = UF.AL;
    ...
    public void createMunicipio() throws Exception {
        ...
        assertThat(testMunicipio.getuF()).isEqualTo(DEFAULT_U_F);
    }
    ...
    public void updateMunicipio() throws Exception {
        ...
        assertThat(testMunicipio.getuF()).isEqualTo(UPDATED_U_F);
    }
