...
public class LogradouroResource {
    ...
    public ResponseEntity<Logradouro> createLogradouro(@RequestBody Logradouro logradouro) throws URISyntaxException {
    ...
    public ResponseEntity<Logradouro> updateLogradouro(@RequestBody Logradouro logradouro) throws URISyntaxException {
